  ...
  checkStandupAttendees: (opts) -> #here is where I should do stuff
    ...
    robot.http(url)
      .get() (err, res, body) ->
        ...
        users = [ {name: "jared", id: "U02JCHHLR", posted: false}, 
          {name: "andylyne", id: "U02JQQKT9", posted: false}, 
          {name: "gemarcano", id: "U02JU3DC9", posted: false}, 
          {name: "jkugs", id: "U02JDPPA0", posted: false} ]
